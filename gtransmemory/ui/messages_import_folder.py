...
SECTION_WINDOW_NAME = 'messages import folder'


class UIMessagesImportFolder(UIBase):
    def __init__(self, parent, settings, options):
        """Prepare the dialog"""
        logging.debug(f'{self.__class__.__name__} init')
        super().__init__(filename='messages_import_folder.ui')
        # Initialize members
        self.parent = parent
    ...
    def show(self):
        ...
        self.ui.dialog.hide()
        self.directory = self.ui.file_chooser_import.get_filename()
