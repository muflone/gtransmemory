...
APP_VERSION = '0.4.0'
APP_DESCRIPTION = 'Memory of terms for translators'
APP_ID = 'gtransmemory.muflone.com'
APP_URL = 'https://www.muflone.com/gtransmemory/'
APP_AUTHOR = 'Fabio Castelli'
APP_AUTHOR_EMAIL = 'muflone@muflone.com'
APP_COPYRIGHT = f'Copyright 2016-2022 {APP_AUTHOR}'
URL_SOURCES = 'https://github.com/muflone/gtransmemory/'
# Other constants
...
try:
    ...
    DIR_MEMORIES = pathlib.Path(BaseDirectory.save_config_path(
        pathlib.Path(DOMAIN_NAME) / 'memories'))
    ...
    DIR_MEMORIES = (pathlib.Path(BaseDirectory.xdg_config_home) /
                    DOMAIN_NAME / 'memories')
