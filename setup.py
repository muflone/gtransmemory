...
setup(
    ...
    license='GPL v2',
    scripts=['gtransmemory.py'],
    packages=['gtransmemory', 'gtransmemory.models', 'gtransmemory.ui'],
    data_files=[
        ('share/gtransmemory/data', ['data/gtransmemory.png']),
        ('share/applications', ['data/gtransmemory.desktop']),
        ('share/doc/gtransmemory', list(chain(glob('doc/*'), glob('*.md')))),
        ('share/gtransmemory/ui', glob('ui/*')),
    ],
    cmdclass={
